...
def check(email):
    url = "https://ybnz97bzaa.execute-api.ap-south-1.amazonaws.com/Plasma/getdata?email="+email
...
def register():
    ...
    if('errorType' in check(x[1])):
        url = "https://ybnz97bzaa.execute-api.ap-south-1.amazonaws.com/Plasma/registration?"+params
...
@app.route('/stats')
def stats():
    url = "https://ybnz97bzaa.execute-api.ap-south-1.amazonaws.com/Plasma/getbloodgroupsdata"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    print(address)
    url = "https://ybnz97bzaa.execute-api.ap-south-1.amazonaws.com/Plasma/requestonbloodgroup?blood="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
    print(a)
    phone=[]
